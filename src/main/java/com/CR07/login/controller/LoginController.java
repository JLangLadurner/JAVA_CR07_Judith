package com.CR07.login.controller;

import javax.validation.Valid;

import com.CR07.login.model.Student;
import com.CR07.login.service.StudentService;
...
public class LoginController {
    ...
    public ModelAndView createNewStudent(@Valid Student student, BindingResult bindingResult) {
        ModelAndView modelAndView = new ModelAndView();
        Student studentExists = studentService.findByEmail(student.getEmail());//findUserByEmail
